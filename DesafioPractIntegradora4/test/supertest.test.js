...
describe("Pruebas con supertest", () => {
  ...
  const product = {
    title: "Hugo Boss",
    description: "Fragancia de hombre",
    price: 900,
    stock: 20,
    code: "c1-p3r",
  };
  ...
  before(async function () {
    await mongoose.connect(
      'mongodb+srv://iscmond:6J1jEnBNBxi4QOyM@codercluster.tfnyhde.mongodb.net/retryWrites=true&w=majority/ecommerce'
    );
